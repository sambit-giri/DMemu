...
The package provides emulators to model the power spectrum from different dark matter models along with the emulation methods used to build them. 

## INSTALLATION

To install the package from source, one should clone this package running the following::

    git clone https://github.com/sambit-giri/DMemu.git
...
One can also install it using pip by running the following command::
    ...
    pip install git+https://github.com/sambit-giri/DMemu.git

The dependencies should be installed automatically during the installation process. If they fail for some reason, you can install them manually before installing DMemu. The list of required packages can be found in the requirements.txt file present in the root directory.
...
If you find any bugs or unexpected behavior in the code, please feel free to open a [Github issue](https://github.com/sambit-giri/DMemu/issues). The issue page is also good if you seek help or have suggestions for us. 
